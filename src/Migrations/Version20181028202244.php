 ...
 */
final class Version20181028202244 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, duration_id INT NOT NULL, discount_id INT DEFAULT NULL, ticket_order_id INT DEFAULT NULL, visit_date DATETIME NOT NULL, ticket_price INT NOT NULL, visitor_birth_date DATETIME NOT NULL, visitor_first_name VARCHAR(255) DEFAULT NULL, visitor_name VARCHAR(255) NOT NULL, booked TINYINT(1) NOT NULL, INDEX IDX_97A0ADA337B987D8 (duration_id), INDEX IDX_97A0ADA34C7C611F (discount_id), INDEX IDX_97A0ADA38F691B9 (ticket_order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
